...
import {  getAllCourrielsDepartNotToday, getCourielDepartById } from "./servicesBackEnd/gestion-couriel-api";
import { AppContextCourielDepartNotToday,  AppContextMenuToggle,  AppContextToken } from "./context/contextApp";
...
function CourielDepartHistorique(){
	...
	function handleFilter(e) {
		...
		if(researchText === ""){
			getAllCourrielsDepartNotToday().then(resp => {
				setStateCourielDepartNotToday(resp.data)
			})
		}else{
			const recors = stateCourielDepartNotToday.filter((row) => {
				return row.objet.toLowerCase().includes(researchText);
		});
		setStateCourielDepartNotToday(recors);
		}
	}
		...
		<div className="row page-titles mx-0">
                    <div className="col-sm-6 p-md-0">
					    <ol className="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a >Départ</a></li>
                        </ol>
                        
                    </div>
                    <div className="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
					    <div className="welcome-text">
                            <h4>Courriels de départ - Historique</h4>
                        </div>
                    </div>
                </div>	
			...
			<div className="col-12">
			  <div className="card">
				...
				<div className="card-body">
					  ...
					  <DataTable 
						  columns={columns} 
						  data={stateCourielDepartNotToday}  
						  fixedHeader
						  pagination
						  striped
						  /> 
...
export default CourielDepartHistorique;