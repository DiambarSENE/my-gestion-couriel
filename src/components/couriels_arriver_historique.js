...
import {  getAllCourrielsArriverNotToday,  getCourielArriverById } from "./servicesBackEnd/gestion-couriel-api";
import { AppContextCategorie, AppContextCourielArriverNotToday,  AppContextExpediteur,  AppContextMenuToggle,  AppContextToken } from "./context/contextApp";
...
function CourielArriverHistorique(){
	...
	const [filePdf, setFilePdf] = useState(null);
	 ...
	 let fileUrl = "http://localhost:8086/couriel/getFilePdfArriver/"+filePdf;
	...
	function handleFilter(e) {
		...
		if(researchText === ""){
			getAllCourrielsArriverNotToday().then(resp => {
				setStateCourielArriverNotToday(resp.data)
			})
		}else{
			const recors = stateCourielArriverNotToday.filter((row) => {
				return row.expediteur.toLowerCase().includes(researchText);
		});
		setStateCourielArriverNotToday(recors);
		}
	}
		...
		<div className="row page-titles mx-0">
                    <div className="col-sm-6 p-md-0">
					   <ol className="breadcrumb">
                            <li className="breadcrumb-item"><a>Historiques</a></li>
                        
                            <li className="breadcrumb-item active"><a >Arriver</a></li>
                        </ol>
                       
                    </div>
                    <div className="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
					<div className="welcome-text">
                            <h4>Historique des courriels d'arrivée</h4>
                        </div>
                    </div>
                </div>
			...
			<div className="col-12">
			  <div className="card">
				...
				<div className="card-body">
					  ...
					  <DataTable 
						  columns={columns} 
						  data={stateCourielArriverNotToday}  
						  fixedHeader
						  pagination
						  striped
						  /> 
...
export default CourielArriverHistorique;